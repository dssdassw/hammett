...
ts=ref("Player: statement number 1\nSuspect: statement number 2\nPlayer: statement number 3\n") #A pointer, pointing to the transcript. I had to use pointers (created with the "ref" class) for a lot of things, as Tk doesn't return values.
script=["This is a story ", "all about how ", "my life got flipped-turned upside-down ", "I'd like to take a minute; just sit right there, let me tell you about how I became the prince of a town called Bel-Air.", "Is there anything wrong with this story?\n\nA. No.\n\nB. He isn't the fresh prince of Bel-Air\n\nC. The fresh prince of Bel-Air would never tell a cabbie that he would smell him later.\n\nD. I'm not an idiot I swar on me mum.\n\n(Please complete the popup, then click next.)", '!A'] #best script.
...
while twistID==0:
	...
	print '}'
print "Task #",twistID," has been completed.\n------------------------\n\n\n\n\n"
...
while twistID==1:
	...
	print '}'
print "Task #",twistID," has been completed.\n------------------------\n\n\n\n\n"
twist2=judgePopup(Toplevel(root), (1,0), (abcd2, cproof2), "YOU'RE GODDAMN RIGHT", "Excuse me, but are you a fucking moron?")
root.mainloop()
print "- FIN -"